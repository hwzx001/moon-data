...
Author  : Lucky 
Update Content ：
    1、modify：fun getIndexPageTitleANDShopSocail
        parse the html with pyquery library 

    2、modify: fun getProductUrl
        some products url more than one page
    ...
    3、add   : class multiRecord 
    4、delete：class addRecord
    5、Need To Do：to modify the 'ShopNumofProducts' through json content
        Some companies have hidden product pages：Ex https://alohagolfcenter.net/sitemap.xml
'''
